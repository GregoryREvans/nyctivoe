...
maker = evans.SegmentMaker(
    ...
    commands=[
        ...
        evans.MusicCommand(
            ...
            lambda _: baca.hairpin(_, "mf > pp", pieces=lambda x: abjad.select.runs(x)),
            evans.Attachment(
                abjad.Clef("treble"),
